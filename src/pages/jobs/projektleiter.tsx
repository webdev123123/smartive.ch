import { Copy, PageSection, UnorderedList } from '@smartive/guetzli';
...
const Projektleiter: NextPage<Props> = ({ contact, images }) => (
  <Page>
    <PageHeader
      markdownTitle="_Projektleiter_ bei smartive"
      pageTitle="Stellenausschreibung Projektleiter bei smartive"
