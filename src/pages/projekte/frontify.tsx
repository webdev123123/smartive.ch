...
const Frontify: NextPage<Props> = ({ images, teasers, contact }) => {
  return (
    <Page>
      <PageHeader
      ...
      <main>
        ...
        <Section title="Lovestory">
          <Grid cols={2}>
            <div>
              ...
              <TextBlock title="">
                Wir haben kein Produkt im Rücken, sondern diverse Projekte. Und ganz viel Know-how über die neusten
                Technologien und Trends. Wir machen Hackdays und Code-Retreats, erzählen auf Konferenzen, organisieren Labs,
                halten Workshops und: alle <Explainer title={'Nicht die Schokolinse von Nestlé'}>Smarties</Explainer> haben
                ein umfangreiches Weiterbildungsbudget. Damit wir zum Beispiel genau wissen, was der Unterschied zwischen{' '}
                <Link href="https://blog.smartive.ch/how-should-we-react-to-stencil-and-svelte-ca76d631cf95?source=rss----2be72cec0825---4">
                  Stencil und Svelte
                </Link>{' '}
            ...
            <div>
              <TextBlock title="Das erste Date">
                Angefangen hat unsere Zusammenarbeit mit Reviews und Workshops zu Elasticsearch und der Architektur des
                Frontify-Styleguides.
              </TextBlock>
              <TextBlock title="">
        ...
        <Section title="Alles neu">
          <Grid cols={2}>
            ...
            <TextBlock title="Neue Blocks">
              ...
              <Link href="https://www.frontify.com/en/blog/the-new-era-of-brand-guidelines/">deinen eigenen Blocks</Link>{' '}
        ...
        <Section title="Alles besser">
          <TextBlock title="Bessere Accessibility">
            ...
            <Link href="https://smartive.ch/blog/accessible-dropdown-using-react-aria">anspruchsvollen Dropdowns</Link>.
          </TextBlock>
          <Grid cols={2}>
            <div>
              ...
              <TextBlock title="">
                ...
                Nutz einfach die Defaults von <Link href="/was-ist/react#tailwind">Tailwind</Link> und hör auf, Custom Values
                für einzelne Elemente zu definieren. Dann hast du schon mal sehr viel System in deinem Design. Und genau
                darum gehts bei einem Design-System. 😉
              </TextBlock>
            </div>
            <div>
              ...
              <TextBlock title="">
                Deshalb haben wir mit dem Developer-SDK für Frontify ein CLI-Tool entwickelt, mit dem einzelne Content-Blocks
