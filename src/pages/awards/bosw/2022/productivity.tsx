    ...
    <LandingPage>
      ...
      >
        <Copy>
          ...
          und Kunden, sondern auch die Migros. Als Bottom-up-Initiative wurde der Community Value Loop zur Steigerung der
          Produktivität im Umgang mit Kundenfeedbacks 2021 lanciert.
        </Copy>
      </PageHeader>
      ...
      <main>
        ...
        <Section>
          ...
          <ol className="list-decimal list-outside">
            ...
            <ListItem>
              ...
              auch für Google Shopping-Ads verwendet – denn nicht immer startet die Customer Journey auf einem Migros-eigenen
        ...
        <Section>
          ...
          <Copy>
            ...
            begleiten die Feedbacks der Community bei ihrer Arbeit.
          </Copy>
          <Copy>
        ...
        <Section>
          ...
          <Copy>
            ...
            zugestellt. Gemeinsam mit einer interdisziplinären Arbeitsgruppe interner Stakeholder wurden in mehreren
            Iterationen die Daily E-Mail sowie die Oberfläche des Migipedia-Backends optimiert. Ein Beispiel: Schlechte
            Produktbewertungen stehen am Anfang der Daily E-Mail, was die Übersicht und die Effizienz steigert. Seit dem
            Sommer zeigten Woche für Woche weitere Personen unterschiedlicher Abteilungen Interesse an individuellen Daily
            E-Mails. Im November war es so weit: Der Migros-Community Value Loop mit seinen digitalen, automatisierten
            Massnahmen wurde der Departementsleitung Marketing als innovatives Beispiel für Data-driven Retail für noch mehr
            Kundenfokus und Produktivität vorgestellt.
          </Copy>
        </Section>
        <Section>
          ...
          <Copy>
            ...
            gegenüber stehen Entwicklungskosten für die digitalen Massnahmen des Value Loops von 50’000 Franken.
          </Copy>
        </Section>
        <Section>
          <UnorderedList
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  return {
    props: {
      quote: await transformQuote(Quotes['bettina-bosw22-productivity']),
    },
  };
};
